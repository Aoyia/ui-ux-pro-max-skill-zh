# 幻灯片参考指南 (Slides Reference)

结合 Chart.js 数据可视化、设计令牌 (Design tokens)、响应式布局和撰稿公式的策略型 HTML 演示文稿设计。

## 用法 (Usage)

激活 `design` 技能并指定幻灯片任务，例如“创建商业计划书 (create a pitch deck)”。
...
- 营销演示文稿与商业计划书 (Pitch decks)
- 使用 Chart.js 进行数据驱动的幻灯片可视化
- 采用布局模式的策略性幻灯片设计
- 经过撰稿公式优化的演示文稿内容
- 投资者宣讲会、销售演示、团队周报/月报更新

## 核心特性 (Key Features)

- **Chart.js 集成**：支持柱状图、折线图、饼图、环形图、雷达图
- **设计令牌 (Design Tokens)**：确保间距、颜色、字体排印的一致性
- **响应式设计**：完美适配桌面端和移动端
- **撰稿公式**：内置 AIDA、PAS、FAB 公式
- **布局模式**：包含主视觉、分栏、网格、对比、时间线等多种模式
